...
import editIcon from "../assets/icons/iconseditar.png";
import viewIcon from "../assets/icons/iconsvisualizar.png";
...
const LeadList = ({ leads, refreshLeads }) => {
	...
	const [deletedLeads, setDeletedLeads] = useState(new Set());
	...
	const confirmDelete = async () => {
		if (deletingLead) {
			try {
				...
				setDeletedLeads((prev) => new Set(prev).add(deletingLead.id));
				refreshLeads();
