...
```
cd existing_repo
git remote add origin https://gitlab.com/leads550029/frontend_forleads.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/leads550029/frontend_forleads/-/settings/integrations)
